		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Manage Products With Read and Write",
									"targetURL": "#comaricordproducts-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comaricordproducts-display": {
								"semanticObject": "comaricordproducts",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.aricord.products",
									"url": sap.ui.require.toUrl("com/aricord/products")
								}
							}
						}
					}
